...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async getColV2() {
        let colVs = await this.getServiceV2(this.serviceName, this.type, this.type, this.app ? this.app : 'oa');
        ...
        switch (type) {
          case 'update':
            ...
            break;
          case 'add':
            if (this.defaultCondition && Array.isArray(this.defaultCondition) && colVs._fieldInfo && Array.isArray(
                colVs._fieldInfo)) {

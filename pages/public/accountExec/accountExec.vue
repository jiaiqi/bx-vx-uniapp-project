<template>
  <view class="authorization">
    ...
    <view class="container" v-if="isBindUser || client_env === 'web' || client_env === 'app' || client_env === 'wxh5'">
      ...
      <view class="wrapper">
        ...
        <button v-if="(client_env === 'wxh5' || client_env === 'wxmp') && !isShowUserLogin"
          ...
          @getuserinfo="saveWxUser" :withCredentials="false" :disabled="disabled">
          立即授权
        </button>
        <button v-if="(client_env === 'wxh5' || client_env === 'wxmp') && !isShowUserLogin"
